    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('performance_actors', models.ManyToManyField(to='api.Actor')),
                ('performance_crews', models.ManyToManyField(to='api.Crew')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='crew',
            name='crew_bio',
            field=models.ForeignKey(to='api.CrewResponsibility'),
            preserve_default=True,
        ),
    ]
